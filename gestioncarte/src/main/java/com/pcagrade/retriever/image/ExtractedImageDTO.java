...
public record ExtractedImageDTO(
        Localization localization,
        @Schema(requiredMode = Schema.RequiredMode.REQUIRED)
        String source,          // e.g., extractor name or website
        String url,             // original image URL
        boolean internal,
        @Nullable String base64Image,
        @Nullable String modifiedUrl  // frontend/UI URL
) {

    // Legacy constructor for backward compatibility
    public ExtractedImageDTO(Localization localization, String source, String url, boolean internal, @Nullable String base64Image) {
        this(localization, source, url, internal, base64Image, null);
    }
